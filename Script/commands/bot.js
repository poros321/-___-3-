...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Saeid") || (event.body.toLowerCase() == "Saeid vai") || (event.body.toLowerCase() == "@Saeid") || (event.body.toLowerCase() == "সাইদ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐒𝐀𝐄𝐈𝐃 \\____😘😈🩵🪽 ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 saeid.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61552563954988\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01401786899", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝐒𝐀𝐄𝐈𝐃 \\____😘😈🩵🪽  হাই আমি মেছেন্জার ROBOT  আমার বস সাইদ  আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Nusrat") || (event.body.toLowerCase() == "@Mariam ")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস সাইদ এর বউ এর  আইডি 😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Sadia") || (event.body.toLowerCase() == "Arohi")) {
  ...
  if ((event.body.toLowerCase() == "@Saeid vai ") || (event.body.toLowerCase() == "সাইদ")) {
     return api.sendMessage("🥰-🌺 এটা আমার  সাইদ বস এর নাম লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "BOT ER BACCHA") || (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("️আমার বাচ্চা তো তোমার নানির পেটে..!!🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "tor nanire xudi")) {
     return api.sendMessage("️এত চোদা চুদি করস কেনো দেখা যাবে বাসর-রাতে-তুই-কতো পারিস,
আর না পারলে আমার বস সাইদ কে ডাকিস..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এইদিকে ওইদিকে কি দেখো জানু আমার বস সাইদ  তোমাকে পছন্দ করে😛😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার বস সাইদ কেউ একটা গফ দে<🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে সাইদ বস এর ইনবক্সে চলে যা 🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("ভালোবাসা বলে কিছু হইনা সব মুতার জাগাই গুতা মারার ধান্দা 🥵😪🫦👀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
     return api.sendMessage("হুম ঝাং আমার বস সাইদ  তোমাকে রাইতে ভলোপাসে <🥵", threadID);
   };
